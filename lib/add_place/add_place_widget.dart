        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'gh7plto7' /* Fill out the information below... */,
                ),
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://cdn.create.vista.com/api/media/small/613616948/stock-vector-upload-icon-vector-web-mobile-app-load-data-sign-symbol',
                                                width: 300.0,
                                                height: 200.0,
                                                fit: BoxFit.cover,
                                              ),
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                    ...
                                                    count: _model.roomsValue ??=
                                                        0,
                                                    updateCount: (count) async {
                                                      safeSetState(() => _model
                                                          .roomsValue = count);
                                                      if (_model.roomsValue! <
                                                          0) {
                                                        safeSetState(() {
                                                          _model.roomsValue = 0;
                                                        });
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child:
                                                    ...
                                                    count: _model.bathsValue ??=
                                                        0,
                                                    updateCount: (count) async {
                                                      safeSetState(() => _model
                                                          .bathsValue = count);
                                                      if (_model.bathsValue! <
                                                          0) {
                                                        safeSetState(() {
                                                          _model.bathsValue = 0;
                                                        });
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                FlutterFlowPlacePicker(
                                                  iOSGoogleMapsApiKey:
                                                      'AIzaSyBmS3SvSHZ_en5ecFPT_k37e2UZh48hULI',
                        ...
                        onPressed: () async {
                          await PlacesRecord.collection.doc().set({
                            ...createPlacesRecordData(
                              ...
                              choice: _model.choiceChipsValue1,
                              rooms: _model.roomsValue,
                              beds: _model.bedsValue,
                              baths: _model.bathsValue,
                              location2: _model.placePickerValue.latLng,
                            ...
                            ...mapToFirestore(
                              {
                                'Electronics': _model.choiceChipsValues2,
                                'images': [],
                              },
                            ),
                          });
