                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '2wo8cvkk' /* fill out the Requirements ....... */,
                                ),
                                  ...
                                  FFAppState().filterElectronics =
                                      (_model.choiceChipsValues2 != null &&
                                          ...
                                          : FFAppState()
                                              ...
                                              .toList()
                                              .cast<String>();
                                  FFAppState().MinPrice = _model.minpriceTextController.text !=
                                              ''
                                      ? int.parse(
                                          _model.minpriceTextController.text)
                                      : 0;
                                  FFAppState().FilterRooms =
                                      _model.roomsValue != null
                                          ? _model.roomsValue!
                                          : 0;
                                  FFAppState().filterBeds =
                                      _model.bedsValue != null
                                          ? _model.bedsValue!
                                          : 0;
                                  FFAppState().fillterBaths =
                                      _model.bathsValue != null
                                          ? _model.bathsValue!
                                          : 0;
                                  FFAppState().MaxPrice = _model.maxPriceTextController.text !=
                                              ''
                                      ? int.parse(
