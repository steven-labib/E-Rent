                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'xgs2brdv' /* fill out the Requirements ....... */,
                      ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.choiceChipsValue1 != null &&
                            _model.choiceChipsValue1 != '') {
                          FFAppState().choic = _model.choiceChipsValue1!;
                          FFAppState().filterResult = true;
                          safeSetState(() {});
                        } else {
                          FFAppState().choic = '';
                          safeSetState(() {});
                        ...
                        FFAppState().filterElectronics = _model
                            .choiceChipsValues2!
                            .toList()
                            .cast<String>();
                        FFAppState().filterResult = true;
                        ...
                        if (_model.minPriceTextController.text != '') {
                          FFAppState().MinPrice =
                              int.parse(_model.minPriceTextController.text);
                          FFAppState().filterResult = true;
                          safeSetState(() {});
                        } else {
                          FFAppState().MinPrice = 0;
                          safeSetState(() {});
                        }

                        if (_model.maxPriceTextController.text != '') {
                          FFAppState().filterResult = true;
                          FFAppState().MaxPrice =
                              int.parse(_model.maxPriceTextController.text);
                          safeSetState(() {});
                        } else {
                          FFAppState().MaxPrice = 0;
                          safeSetState(() {});
                        }

                        if (_model.countControllerValue1 != null) {
                        ...
                        if (_model.countControllerValue2 != null) {
                          FFAppState().filterBeds =
                              _model.countControllerValue2!;
                          FFAppState().filterResult = true;
                          safeSetState(() {});
                        } else {
                        ...
                        if (_model.countControllerValue3 != null) {
