...
import 'comments2_model.dart';
export 'comments2_model.dart';

class Comments2Widget extends StatefulWidget {
  const Comments2Widget({
    super.key,
    this.commentparameter,
  });

  final PlacesRecord? commentparameter;

  @override
  State<Comments2Widget> createState() => _Comments2WidgetState();
}

class _Comments2WidgetState extends State<Comments2Widget> {
  late Comments2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Comments2Model());
                ...
                child: StreamBuilder<List<CommentsRecord>>(
                  stream: queryCommentsRecord(
                    queryBuilder: (commentsRecord) => commentsRecord.where(
                      'post_type',
                      isEqualTo: widget.commentparameter?.reference.id,
                    ),
                  ),
                    ...
                    onPressed: () async {
                      await CommentsRecord.collection
                          ...
                          .set(createCommentsRecordData(
                            ...
                            postType: widget.commentparameter?.reference.id,
                          ));
                    },
                  ),
                ],
