  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PlacesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PlacesRecord> favoritesPlacesRecordList = snapshot.data!;
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 0.0, 11.0),
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'f3oyggws' /* Favorites Listings  */,
                        ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final favoriteRef =
                                favoritesPlacesRecordList.toList();
                            ...
                            return GridView.builder(
                              ...
                              itemCount: favoriteRef.length,
                              itemBuilder: (context, favoriteRefIndex) {
                                final favoriteRefItem =
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            favoriteRefItem.images.firstOrNull!,
                                            width: 200.0,
                                            height: 150.0,
                                            fit: BoxFit.cover,
                                          ),
