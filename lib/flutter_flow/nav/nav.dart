...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          asyncParams: {
            'placeRef': getDoc(['places'], PlacesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: EditUploadWidget.routeName,
          path: EditUploadWidget.routePath,
          builder: (context, params) => EditUploadWidget(),
        ),
        FFRoute(
          name: MyPostsWidget.routeName,
          path: MyPostsWidget.routePath,
          builder: (context, params) => MyPostsWidget(),
        ),
        FFRoute(
          name: ProfileInfo2Widget.routeName,
          path: ProfileInfo2Widget.routePath,
          builder: (context, params) => ProfileInfo2Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CpayWidget.routeName,
          path: CpayWidget.routePath,
          builder: (context, params) => CpayWidget(),
        ),
        FFRoute(
          name: PpayyWidget.routeName,
          path: PpayyWidget.routePath,
          builder: (context, params) => PpayyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          asyncParams: {
            'reviews':
                getDoc(['places', 'reviews'], ReviewsRecord.fromSnapshot),
            'placeRef': getDoc(['places'], PlacesRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: NotificationOwnerWidget.routeName,
          path: NotificationOwnerWidget.routePath,
          builder: (context, params) => NotificationOwnerWidget(),
        )
