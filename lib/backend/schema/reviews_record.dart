...
class ReviewsRecord extends FirestoreRecord {
  ...
  DateTime? get timeReview => _timeReview;
  bool hasTimeReview() => _timeReview != null;
  ...
  void _initializeFields() {
    ...
    _timeReview = snapshotData['timeReview'] as DateTime?;
  }
...
class ReviewsRecordDocumentEquality implements Equality<ReviewsRecord> {
  ...
  bool equals(ReviewsRecord? e1, ReviewsRecord? e2) {
    return e1?.rating == e2?.rating &&
        ...
        e1?.timeReview == e2?.timeReview;
  }

  @override
  int hash(ReviewsRecord? e) => const ListEquality()
      .hash([e?.rating, e?.review, e?.userRef, e?.timeReview]);
